...
score_rect3 = pygame.Rect(1320, 55, 170, 60)
next_rect3 = pygame.Rect(1320, 215, 170, 180)

screen = pygame.display.set_mode((1500, 620))
...
while True:
    ...
    # player 3
    screen.blit(score_surface, (1365, 20, 50, 50))
    screen.blit(next_surface, (1375, 180, 50, 50))
    ...
    if gameAI3.game_over:
        screen.blit(game_over_surface, (1320, 450, 50, 50))
        file_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "ai_score.txt")
        # Your existing code to check if data is added
        if not added3:
            with open(file_path, "a") as f:
    ...
    gameAI1.draw(screen, x_offset=0)
    gameAI2.draw(screen, x_offset=500)
    gameAI3.draw(screen, x_offset=1000)
